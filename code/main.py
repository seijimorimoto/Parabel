...
def main():
    ...
    if (os.path.exists('data/econbiz/econbiz_labels_vectors.joblib')):
        labels_to_vectors_dict = load('data/econbiz/econbiz_labels_vectors.joblib')
    else:
        ...
        t = time.time()
        transform_labels_to_vectors(input_matrix, labels_occurrences, labels_to_vectors_dict)
